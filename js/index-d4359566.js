import{ba as V,d4 as W,_ as l,a9 as g,a0 as h,$ as a,d as x,O as S,a1 as w,a2 as H,h as t,K as L,P as A,bO as K,d5 as D,k as z,ai as d,am as q,Q,V as b,T as C,bP as G,v as y,j as J,R as $,d6 as U,I as X,N as Y,F as Z,A as ee,m as te}from"./index-e59897ea.js";import{R as ie}from"./relative-time-6a24b62d.js";import{H as ne}from"./rounded-button-19f4dcac.js";import{N as oe}from"./Popconfirm-eaf56252.js";const re=e=>{const{textColor3:o,infoColor:r,errorColor:i,successColor:n,warningColor:s,textColor1:c,textColor2:m,railColor:u,fontWeightStrong:v,fontSize:f}=e;return Object.assign(Object.assign({},W),{contentFontSize:f,titleFontWeight:v,circleBorder:`2px solid ${o}`,circleBorderInfo:`2px solid ${r}`,circleBorderError:`2px solid ${i}`,circleBorderSuccess:`2px solid ${n}`,circleBorderWarning:`2px solid ${s}`,iconColor:o,iconColorInfo:r,iconColorError:i,iconColorSuccess:n,iconColorWarning:s,titleTextColor:c,contentTextColor:m,metaTextColor:o,lineColor:u})},le={name:"Timeline",common:V,self:re};var ae=le;const _=1.25;var se=l("timeline",`
 position: relative;
 width: 100%;
 display: flex;
...
`,[g("horizontal",`
 ...
 position: absolute;
 top: calc(var(--n-title-font-size) * ${_} / 2 - var(--n-icon-size) / 2);
 height: 100%;
 `,[a("circle",`
