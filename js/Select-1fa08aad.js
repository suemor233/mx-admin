...
`,[j("multiple",[y("base-select-option",`
 ...
 `)]),F("render-label",`
 color: var(--n-text-color);
 `)]),We("disabled",[de("&:hover",[F("state-border",`
 ...
 user-select: none;
 opacity: 0;
 `)]),["warning","error"].map(e=>j(`${e}-status`,[F("state-border",`border: var(--n-border-${e});`),We("disabled",[de("&:hover",[F("state-border",`
