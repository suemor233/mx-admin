import{Q as Be,aQ as Kt,l as E,$ as w,a1 as b,a0 as O,d as U,P as Ne,bl as Gt,h as a,bm as ae,bn as ee,bo as ce,bp as Ye,bq as be,br as We,bs as ne,bt as ke,bu as Ke,bv as $t,bw as xe,bx as se,by as De,x as P,b7 as ye,bz as $e,L as Jt,aF as nt,z as St,bA as _e,bB as Ge,bC as Je,bD as et,ag as en,aw as tn,aa as te,ad as nn,O as rn,a2 as Se,a3 as Re,T as Ae,ae as ut,w as je,aj as dt,S as rt,b0 as Ct,b1 as tt,ap as on,aq as sn,ar as ln,as as it,b2 as Ve,b4 as an,bE as cn,a8 as me,N as ue,aX as un,bb as dn,k as zt,bF as ot,bG as hn,bH as pn,bI as fn,b3 as ht,bJ as gn,ac as mn,ao as _t,bK as qe,bL as bn,an as pt,bM as xn,bN as vn,bO as wn,bP as kn,bf as yn,o as Rt,e as At,f as st,bQ as $n,bR as Sn,bS as Cn,bT as zn,bU as _n,p as Rn,bV as An,I as In,a as ft,F as Bn}from"./index-524a5fea.js";import{N as It}from"./Form-88a5f5a7.js";import{N as le}from"./FormItem-5f07fc31.js";import{N as En}from"./Switch-e7f8dc87.js";import{N as Tn,a as Pn}from"./CollapseItem-1b901df8.js";import{N as gt}from"./InputNumber-f05d5864.js";import{N as Un}from"./ButtonGroup-188ad4c8.js";import{H as Dn}from"./rounded-button-4d26df67.js";import{P as jn}from"./toggle-e8b30ce6.js";import{l as Fn}from"./js-yaml-fae8e8ce.js";function Mn(r,e){const t=Be(Kt,null);return E(()=>r.hljs||t?.mergedHljsRef.value)}var Vn=w("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
...
Please report this to https://github.com/markedjs/marked.`,e.silent)return"<p>An error occurred:</p><pre>"+M(t.message+"",!0)+"</pre>";throw t}};v.Parser=ie;v.parser=ie.parse;v.Renderer=ct;v.TextRenderer=Dt;v.Lexer=re;v.lexer=re.lex;v.Tokenizer=at;v.Slugger=jt;v.parse=v;ie.parse;re.lex;const gi=r=>{const e=v.lexer(r),t=new Set;function n(i){if(i.type==="image"){t.add(i.href);return}if(i.tokens&&Array.isArray(i.tokens))return i.tokens.forEach(n)}return e.forEach(n),[...t.values()]},Ei=U({props:{show:{type:Boolean,required:!0},onUpdateShow:{type:Function,required:!0},data:{type:Object,required:!0}},setup(r,{slots:e}){return()=>a(Dr,{show:r.show,width:450,class:"max-w-[90vw]",placement:"right",onUpdateShow:r.onUpdateShow},a(Fr,{title:"\u6587\u7AE0\u8BBE\u5B9A"},a(It,{labelAlign:"right",labelPlacement:"left",labelWidth:100},e.default?.(),a(le,{label:"\u5141\u8BB8\u8BC4\u8BBA"},a(En,{value:r.data.allowComment,onUpdateValue:t=>void(r.data.allowComment=t)})),a(le,{label:"\u56FE\u7247\u8BBE\u5B9A"}),a(le,null,a(mi,{text:r.data.text,images:r.data.images,onChange:t=>{r.data.images=t}})))))}}),mi=U({props:{images:{type:Array,required:!0},onChange:{type:Function,required:!0},text:{type:String,required:!0}},setup(r){const e=P(!1),t=E(()=>{const o=new Map;return r.images.forEach(s=>{o.set(s.src,s)}),o}),n=E(()=>r.text?gi(r.text).map(o=>{const s=t.value.get(o);return{src:o,height:s?.height,width:s?.width,type:s?.type,accent:s?.accent}}):r.images),i=async()=>{e.value=!0;try{const o=await Promise.all(n.value.map((s,l)=>new Promise((c,f)=>{const d=new Image;d.src=s.src,d.crossOrigin="Anonymous",d.onload=()=>{c({width:d.naturalWidth,height:d.naturalHeight,src:s.src,type:d.src.split(".").pop()||"",accent:Kr(d)})},d.onerror=$=>{f($)}})));e.value=!1,r.onChange(o)}catch(o){console.error(o)}finally{e.value=!1}};return()=>a("div",{class:"relative w-full flex flex-col flex-grow"},a("div",{class:"flex justify-between space-x-2 items-center pr-4"},a("div",{class:"flex-grow flex-shrink inline-block"},"\u8C03\u6574 Markdown \u4E2D\u5305\u542B\u7684\u56FE\u7247\u4FE1\u606F"),a(ue,{loading:e.value,class:"self-end",round:!0,onClick:i},"\u81EA\u52A8\u4FEE\u6B63")),a(Tn,{accordion:!0,class:"mt-4"},n.value.map((o,s)=>a(Pn,{key:o.src,title:a("span",{class:"w-full flex flex-shrink break-all"},o.src)},a(It,{labelPlacement:"left",labelWidth:"100"},a(le,{label:"\u9AD8\u5EA6"},a(gt,{value:o.height,onUpdateValue:l=>{!l||(r.images[s].height=l)}})),a(le,{label:"\u5BBD\u5EA6"},a(gt,{value:o.width,onUpdateValue:l=>{!l||(r.images[s].width=l)}})),a(le,{label:"\u7C7B\u578B"},a(St,{value:o.type||"",onUpdateValue:l=>{!l||(r.images[s].type=l)}})),a(le,{label:"\u4E3B\u8272\u8C03"},a(fr,{value:o.accent||"",onUpdateValue:l=>{!l||(r.images[s].accent=l)}})),a(le,{label:"\u64CD\u4F5C"},a("div",{class:"flex justify-end w-full"},a(Un,null,a(ue,{round:!0,onClick:()=>{window.open(o.src)},secondary:!0},"\u67E5\u770B"),a(ue,{secondary:!0,round:!0,type:"error",onClick:()=>{r.images.splice(s,1)}},"\u5220\u9664")))))))))}}),bi={type:{type:String},value:{type:String,required:!0},placeholder:{type:String},onChange:{type:Function,required:!0}},xi="_root_1e9b2_1",vi="_group_1e9b2_5",wi="_bar_1e9b2_47";var Xe={root:xi,group:vi,bar:wi};const Ti=U({props:{...bi,label:{type:String,required:!0}},emits:["compositionend","compositionstart"],setup(r,{emit:e}){const t=P();return zt(()=>{!t.value||(t.value.addEventListener("compositionstart",()=>{e("compositionstart")}),t.value.addEventListener("compositionend",()=>{e("compositionend")}))}),()=>a("div",{class:Sn(Xe.root,Xe.group)},a("input",{required:!0,ref:t,type:r.type??"text",value:r.value,onInput:n=>r.onChange(n.target.value)}),a("span",{class:Xe.bar}),a("label",null,r.label))}}),Pi=U({props:{data:{type:Object,required:!0},onHandleYamlParsedMeta:{type:Function,required:!1}},setup(r){const e=P(!1),t=P(""),n=i=>{i=i.trim();const o=/^---\n((.|\n)*?)\n---/.exec(i);if(o?.length){const f=o[1],d=Fn(f);r.onHandleYamlParsedMeta&&r.onHandleYamlParsedMeta(d),i=i.replace(o[0],"")}const l=i.trim().split(`
`),c=l[0].startsWith("#")?l[0].replace(/^#/,"").trim():"";c&&(r.data.title=c,l.shift()),r.data.text=l.join(`
`).trim(),e.value=!1};return()=>a(Bn,null,a(Dn,{icon:a(Qr,null),variant:"info",onClick:()=>e.value=!0}),a(Cn,{transformOrigin:"center",show:e.value,onUpdateShow:i=>e.value=i},a(zn,{class:"modal-card",closable:!0,onClose:()=>e.value=!1},{header(){return a("div",{class:"space-x-4 relative flex items-center"},a(_n,null,"\u89E3\u6790 Markdown"),a(Rn,{trigger:"hover",placement:"right"},{default(){return a("div",{class:"max-w-[80ch] overflow-auto"},a(An,null,"\u53EF\u4EE5\u89E3\u6790 Markdown with YAML \u683C\u5F0F\u7684\u6587\u672C\uFF0C\u4F8B\u5982\uFF1A"),a(wr,{code:`---
...
\u865A\u62DF\u5217\u8868\u662F\u4E3A\u4E86\u63D0\u9AD8\u9875\u9762\u6027\u80FD\u800C\u51FA\u73B0\u7684\u3002`}))},trigger(){return a(In,null,a(qr,null))}}))},default(){return a(ft,{vertical:!0,size:"large"},a(jn,{class:"h-[70vh]",onChange:i=>void(t.value=i),text:t.value,unSaveConfirm:!1}),a(ft,{justify:"end"},a(ue,{round:!0,type:"primary",onClick:()=>n(t.value)},"\u786E\u5B9A"),a(ue,{onClick:i=>{t.value=""},round:!0},"\u91CD\u7F6E")))}})))}});export{Ti as M,Pi as P,Bi as S,Ei as T,bi as i};
