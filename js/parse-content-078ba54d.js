import{P as Be,aP as Kt,k as E,_ as w,a0 as b,$ as O,d as U,O as Ne,bk as Gt,h as a,bl as ae,bm as ee,bn as ce,bo as Ye,bp as be,bq as We,br as ne,bs as ke,bt as Ke,bu as $t,bv as ve,bw as se,bx as De,v as P,b6 as ye,by as $e,K as Jt,aE as nt,y as St,bz as ze,bA as Ge,bB as Je,bC as et,af as en,av as tn,a9 as te,ac as nn,L as rn,a1 as Se,a2 as Re,S as Ae,ad as ut,w as je,ai as dt,Q as rt,a$ as Ct,b0 as tt,ao as on,ap as sn,aq as ln,ar as it,b1 as Ve,b3 as an,bD as cn,a7 as me,N as ue,aW as un,ba as dn,j as _t,bE as ot,bF as hn,bG as pn,bH as fn,b2 as ht,bI as gn,ab as mn,an as zt,bJ as qe,bK as bn,am as pt,bL as vn,bM as xn,bN as wn,bO as kn,be as yn,o as Rt,b as At,e as st,bP as $n,bQ as Sn,bR as Cn,bS as _n,bT as zn,bU as Rn,n as An,bV as In,I as Bn,a as ft,F as En}from"./index-e59897ea.js";import{N as It}from"./Form-d440dafb.js";import{N as le}from"./FormItem-5df1dc7f.js";import{N as Tn}from"./Switch-270a5721.js";import{N as Pn,a as Un}from"./CollapseItem-f496c64f.js";import{N as gt}from"./InputNumber-4c16a190.js";import{H as Dn}from"./rounded-button-19f4dcac.js";import{P as jn}from"./toggle-33f81369.js";import{l as Fn}from"./js-yaml-fae8e8ce.js";function Mn(r,e){const t=Be(Kt,null);return E(()=>r.hljs||t?.mergedHljsRef.value)}var Vn=w("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
...
`,[b(">",[w("input",[b("&:not(:last-child)",`
 ...
 filter: blur(2px);
 content: "";
 `)])])])])]);const pr=Object.assign(Object.assign({},Se.props),{value:String,show:{type:Boolean,default:void 0},defaultShow:{type:Boolean,default:!1},defaultValue:String,modes:{type:Array,default:()=>["rgb","hex","hsl"]},placement:{type:String,default:"bottom-start"},to:tt.propTo,showAlpha:{type:Boolean,default:!0},showPreview:Boolean,swatches:Array,disabled:{type:Boolean,default:void 0},actions:{type:Array,default:null},internalActions:Array,size:String,renderLabel:Function,onComplete:Function,"onUpdate:show":[Function,Array],onUpdateShow:[Function,Array],"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]});var fr=U({name:"ColorPicker",props:pr,setup(r,{slots:e}){const t=P(null);let n=null;const i=nn(r),{mergedSizeRef:o,mergedDisabledRef:s}=i,{localeRef:l}=rn("global"),{mergedClsPrefixRef:c,namespaceRef:f,inlineThemeDisabled:d}=Ne(r),$=Se("ColorPicker","-color-picker",hr,cn,r,c);Re(lt,{themeRef:$,renderLabelRef:Ae(r,"renderLabel"),colorPickerSlots:e});const m=P(r.defaultShow),h=ut(Ae(r,"show"),m);function k(u){const{onUpdateShow:C,"onUpdate:show":I}=r;C&&me(C,u),I&&me(I,u),m.value=u}const{defaultValue:y}=r,_=P(y===void 0?qn(r.modes,r.showAlpha):y),v=ut(Ae(r,"value"),_),S=P([v.value]),D=P(0),N=E(()=>Ie(v.value)),{modes:H}=r,R=P(Ie(v.value)||H[0]||"rgb");function Y(){const{modes:u}=r,{value:C}=R,I=u.findIndex(T=>T===C);~I?R.value=u[(I+1)%u.length]:R.value="rgb"}let A,F,Z,oe,W,K,G,L;const de=E(()=>{const{value:u}=v;if(!u)return null;switch(N.value){case"hsv":return ve(u);case"hsl":return[A,F,Z,L]=ke(u),[...$t(A,F,Z),L];case"rgb":case"hex":return[W,K,G,L]=ee(u),[...We(W,K,G),L]}}),he=E(()=>{const{value:u}=v;if(!u)return null;switch(N.value){case"rgb":case"hex":return ee(u);case"hsv":return[A,F,oe,L]=ve(u),[...se(A,F,oe),L];case"hsl":return[A,F,Z,L]=ke(u),[...Ke(A,F,Z),L]}}),Le=E(()=>{const{value:u}=v;if(!u)return null;switch(N.value){case"hsl":return ke(u);case"hsv":return[A,F,oe,L]=ve(u),[...De(A,F,oe),L];case"rgb":case"hex":return[W,K,G,L]=ee(u),[...Ye(W,K,G),L]}}),Ft=E(()=>{switch(R.value){case"rgb":case"hex":return he.value;case"hsv":return de.value;case"hsl":return Le.value}}),Ee=P(0),He=P(1),Ze=P([0,0]);function Mt(u,C){const{value:I}=de,T=Ee.value,j=I?I[3]:1;Ze.value=[u,C];const{showAlpha:B}=r;switch(R.value){case"hsv":V((B?be:et)([T,u,C,j]),"cursor");break;case"hsl":V((B?ce:Ge)([...De(T,u,C),j]),"cursor");break;case"rgb":V((B?ne:Je)([...se(T,u,C),j]),"cursor");break;case"hex":V((B?ae:ze)([...se(T,u,C),j]),"cursor");break}}function Vt(u){Ee.value=u;const{value:C}=de;if(!C)return;const[,I,T,j]=C,{showAlpha:B}=r;switch(R.value){case"hsv":V((B?be:et)([u,I,T,j]),"cursor");break;case"rgb":V((B?ne:Je)([...se(u,I,T),j]),"cursor");break;case"hex":V((B?ae:ze)([...se(u,I,T),j]),"cursor");break;case"hsl":V((B?ce:Ge)([...De(u,I,T),j]),"cursor");break}}function Ot(u){switch(R.value){case"hsv":[A,F,oe]=de.value,V(be([A,F,oe,u]),"cursor");break;case"rgb":[W,K,G]=he.value,V(ne([W,K,G,u]),"cursor");break;case"hex":[W,K,G]=he.value,V(ae([W,K,G,u]),"cursor");break;case"hsl":[A,F,Z]=Le.value,V(ce([A,F,Z,u]),"cursor");break}He.value=u}function V(u,C){C==="cursor"?n=u:n=null;const{nTriggerFormChange:I,nTriggerFormInput:T}=i,{onUpdateValue:j,"onUpdate:value":B}=r;j&&me(j,u),B&&me(B,u),I(),T(),_.value=u}function Nt(u){V(u,"input"),un(xe)}function xe(u=!0){const{value:C}=v;if(C){const{nTriggerFormChange:I,nTriggerFormInput:T}=i,{onComplete:j}=r;j&&j(C);const{value:B}=S,{value:Q}=D;u&&(B.splice(Q+1,B.length,C),D.value=Q+1),I(),T()}}function qt(){const{value:u}=D;u-1<0||(V(S.value[u-1],"input"),xe(!1),D.value=u-1)}function Lt(){const{value:u}=D;u<0||u+1>=S.value.length||(V(S.value[u+1],"input"),xe(!1),D.value=u+1)}function Ht(){k(!1)}const Zt=E(()=>D.value>=1),Qt=E(()=>{const{value:u}=S;return u.length>1&&D.value<u.length-1});je(h,u=>{u||(S.value=[v.value],D.value=0)}),nt(()=>{if(!(n&&n===v.value)){const{value:u}=de;u&&(Ee.value=u[0],He.value=u[3],Ze.value=[u[1],u[2]])}n=null});const Qe=E(()=>{const{value:u}=o,{common:{cubicBezierEaseInOut:C},self:{textColor:I,color:T,panelFontSize:j,boxShadow:B,border:Q,borderRadius:q,dividerColor:pe,[dt("height",u)]:Yt,[dt("fontSize",u)]:Wt}}=$.value;return{"--n-bezier":C,"--n-text-color":I,"--n-color":T,"--n-panel-font-size":j,"--n-font-size":Wt,"--n-box-shadow":B,"--n-border":Q,"--n-border-radius":q,"--n-height":Yt,"--n-divider-color":pe}}),J=d?rt("color-picker",E(()=>o.value[0]),Qe,r):void 0;function Xt(){var u;const{value:C}=he,{value:I}=Ee,{internalActions:T,modes:j,actions:B}=r,{value:Q}=$,{value:q}=c;return a("div",{class:[`${q}-color-picker-panel`,J?.themeClass.value],onDragstart:pe=>{pe.preventDefault()},style:d?void 0:Qe.value},a("div",{class:`${q}-color-picker-control`},a(Jn,{clsPrefix:q,rgba:C,displayedHue:I,displayedSv:Ze.value,onUpdateSV:Mt,onComplete:xe}),a("div",{class:`${q}-color-picker-preview`},a("div",{class:`${q}-color-picker-preview__sliders`},a(Wn,{clsPrefix:q,hue:I,onUpdateHue:Vt,onComplete:xe}),r.showAlpha?a(Gn,{clsPrefix:q,rgba:C,alpha:He.value,onUpdateAlpha:Ot,onComplete:xe}):null),r.showPreview?a(dr,{clsPrefix:q,mode:R.value,color:he.value&&ze(he.value),onUpdateColor:pe=>V(pe,"input")}):null),a(sr,{clsPrefix:q,showAlpha:r.showAlpha,mode:R.value,modes:j,onUpdateMode:Y,value:v.value,valueArr:Ft.value,onUpdateValue:Nt}),((u=r.swatches)===null||u===void 0?void 0:u.length)&&a(ur,{clsPrefix:q,mode:R.value,swatches:r.swatches,onUpdateColor:pe=>V(pe,"input")})),B?.length?a("div",{class:`${q}-color-picker-action`},B.includes("confirm")&&a(ue,{size:"small",onClick:Ht,theme:Q.peers.Button,themeOverrides:Q.peerOverrides.Button},{default:()=>l.value.confirm})):null,e.action?a("div",{class:`${q}-color-picker-action`},{default:e.action}):T?a("div",{class:`${q}-color-picker-action`},T.includes("undo")&&a(ue,{size:"small",onClick:qt,disabled:!Zt.value,theme:Q.peers.Button,themeOverrides:Q.peerOverrides.Button},{default:()=>l.value.undo}),T.includes("redo")&&a(ue,{size:"small",onClick:Lt,disabled:!Qt.value,theme:Q.peers.Button,themeOverrides:Q.peerOverrides.Button},{default:()=>l.value.redo})):null)}return{mergedClsPrefix:c,namespace:f,selfRef:t,hsla:Le,rgba:he,mergedShow:h,mergedDisabled:s,isMounted:Ct(),adjustedTo:tt(r),mergedValue:v,handleTriggerClick(){k(!0)},handleClickOutside(u){var C;!((C=t.value)===null||C===void 0)&&C.contains(u.target)||k(!1)},renderPanel:Xt,cssVars:d?void 0:Qe,themeClass:J?.themeClass,onRender:J?.onRender}},render(){const{$slots:r,mergedClsPrefix:e,onRender:t}=this;return t?.(),a("div",{class:[this.themeClass,`${e}-color-picker`],ref:"selfRef",style:this.cssVars},a(on,null,{default:()=>[a(sn,null,{default:()=>a(lr,{clsPrefix:e,value:this.mergedValue,hsla:this.hsla,disabled:this.mergedDisabled,onClick:this.handleTriggerClick},{label:r.label})}),a(ln,{placement:this.placement,show:this.mergedShow,containerClass:this.namespace,teleportDisabled:this.adjustedTo===tt.tdkey,to:this.adjustedTo},{default:()=>a(it,{name:"fade-in-scale-up-transition",appear:this.isMounted},{default:()=>this.mergedShow?Ve(this.renderPanel(),[[an,this.handleClickOutside,void 0,{capture:!0}]]):null})})]}))}});const gr=r=>{const{textColor2:e,fontSize:t,fontWeightStrong:n}=r;return{textColor:e,fontSize:t,fontWeightStrong:n,"mono-3":"#a0a1a7","hue-1":"#0184bb","hue-2":"#4078f2","hue-3":"#a626a4","hue-4":"#50a14f","hue-5":"#e45649","hue-5-2":"#c91243","hue-6":"#986801","hue-6-2":"#c18401"}},mr={name:"Code",common:dn,self:gr};var br=mr,vr=b([w("code",`
 font-size: var(--n-font-size);
 ...
 }`]}]);const xr=Object.assign(Object.assign({},Se.props),{language:String,code:{type:String,default:""},trim:{type:Boolean,default:!0},hljs:Object,uri:Boolean,inline:Boolean,wordWrap:Boolean,internalFontSize:Number,internalNoHighlight:Boolean});var wr=U({name:"Code",props:xr,setup(r,{slots:e}){const{internalNoHighlight:t}=r,{mergedClsPrefixRef:n,inlineThemeDisabled:i}=Ne(),o=P(null),s=t?{value:void 0}:Mn(r),l=(m,h,k)=>{const{value:y}=s;return!y||!(m&&y.getLanguage(m))?null:y.highlight(k?h.trim():h,{language:m}).value},c=()=>{if(e.default)return;const{value:m}=o;if(!m)return;const{language:h}=r,k=r.uri?window.decodeURIComponent(r.code):r.code;if(h){const _=l(h,k,r.trim);if(_!==null){m.innerHTML=r.inline?_:`<pre>${_}</pre>`;return}}if(r.inline){m.textContent=k;return}const y=m.children[0];if(y&&y.tagName==="PRE")y.textContent=k;else{const _=document.createElement("pre");_.textContent=k,m.innerHTML="",m.appendChild(_)}};_t(c),je(Ae(r,"language"),c),je(Ae(r,"code"),c),t||je(s,c);const f=Se("Code","-code",vr,br,r,n),d=E(()=>{const{common:{cubicBezierEaseInOut:m,fontFamilyMono:h},self:{textColor:k,fontSize:y,fontWeightStrong:_,"mono-3":v,"hue-1":S,"hue-2":D,"hue-3":N,"hue-4":H,"hue-5":R,"hue-5-2":Y,"hue-6":A,"hue-6-2":F}}=f.value,{internalFontSize:Z}=r;return{"--n-font-size":Z?`${Z}px`:y,"--n-font-family":h,"--n-font-weight-strong":_,"--n-bezier":m,"--n-text-color":k,"--n-mono-3":v,"--n-hue-1":S,"--n-hue-2":D,"--n-hue-3":N,"--n-hue-4":H,"--n-hue-5":R,"--n-hue-5-2":Y,"--n-hue-6":A,"--n-hue-6-2":F}}),$=i?rt("code",E(()=>`${r.internalFontSize||"a"}`),d,r):void 0;return{mergedClsPrefix:n,codeRef:o,cssVars:i?void 0:d,themeClass:$?.themeClass,onRender:$?.onRender}},render(){const{mergedClsPrefix:r,wordWrap:e,onRender:t}=this;return t?.(),a("code",{class:[`${r}-code`,this.themeClass,e&&`${r}-code--word-wrap`],style:this.cssVars,ref:"codeRef"},this.$slots)}}),kr=U({name:"NDrawerContent",inheritAttrs:!1,props:{show:{type:Boolean,default:void 0},displayDirective:{type:String,required:!0},placement:{type:String,required:!0},contentStyle:[Object,String],nativeScrollbar:{type:Boolean,required:!0},scrollbarProps:Object,trapFocus:{type:Boolean,default:!0},autoFocus:{type:Boolean,default:!0},onAfterLeave:Function,onAfterEnter:Function,onEsc:Function},setup(r){const e=P(r.show),t=P(null),n=Be(ot);nt(()=>{r.show&&(e.value=!0)});function i(){var o;e.value=!1,(o=r.onAfterLeave)===null||o===void 0||o.call(r)}return Re(hn,t),Re(pn,null),Re(fn,null),{bodyRef:t,mergedClsPrefix:n.mergedClsPrefixRef,isMounted:n.isMountedRef,mergedTheme:n.mergedThemeRef,displayed:e,transitionName:E(()=>({right:"slide-in-from-right-transition",left:"slide-in-from-left-transition",top:"slide-in-from-top-transition",bottom:"slide-in-from-bottom-transition"})[r.placement]),handleAfterLeave:i}},render(){const{$slots:r,mergedClsPrefix:e}=this;return this.displayDirective==="show"||this.displayed||this.show?Ve(a("div",{role:"none"},a(gn,{disabled:!this.trapFocus,active:this.show,autoFocus:this.autoFocus,onEsc:this.onEsc},{default:()=>a(it,{name:this.transitionName,appear:this.isMounted,onAfterEnter:this.onAfterEnter,onAfterLeave:this.handleAfterLeave},{default:()=>Ve(a("div",mn(this.$attrs,{role:"dialog",ref:"bodyRef","aria-modal":"true",class:[`${e}-drawer`,`${e}-drawer--${this.placement}-placement`,this.nativeScrollbar&&`${e}-drawer--native-scrollbar`]}),[this.nativeScrollbar?a("div",{class:`${e}-drawer-content-wrapper`,style:this.contentStyle,role:"none"},r):a(zt,Object.assign({},this.scrollbarProps,{contentStyle:this.contentStyle,contentClass:`${e}-drawer-content-wrapper`,theme:this.mergedTheme.peers.Scrollbar,themeOverrides:this.mergedTheme.peerOverrides.Scrollbar}),r)]),[[ht,this.show]])})})),[[ht,this.displayDirective==="if"||this.displayed||this.show]]):null}});const{cubicBezierEaseIn:yr,cubicBezierEaseOut:$r}=qe;function Sr({duration:r="0.3s",leaveDuration:e="0.2s",name:t="slide-in-from-right"}={}){return[b(`&.${t}-transition-leave-active`,{transition:`transform ${e} ${yr}`}),b(`&.${t}-transition-enter-active`,{transition:`transform ${r} ${$r}`}),b(`&.${t}-transition-enter-to`,{transform:"translateX(0)"}),b(`&.${t}-transition-enter-from`,{transform:"translateX(100%)"}),b(`&.${t}-transition-leave-from`,{transform:"translateX(0)"}),b(`&.${t}-transition-leave-to`,{transform:"translateX(100%)"})]}const{cubicBezierEaseIn:Cr,cubicBezierEaseOut:_r}=qe;function zr({duration:r="0.3s",leaveDuration:e="0.2s",name:t="slide-in-from-left"}={}){return[b(`&.${t}-transition-leave-active`,{transition:`transform ${e} ${Cr}`}),b(`&.${t}-transition-enter-active`,{transition:`transform ${r} ${_r}`}),b(`&.${t}-transition-enter-to`,{transform:"translateX(0)"}),b(`&.${t}-transition-enter-from`,{transform:"translateX(-100%)"}),b(`&.${t}-transition-leave-from`,{transform:"translateX(0)"}),b(`&.${t}-transition-leave-to`,{transform:"translateX(-100%)"})]}const{cubicBezierEaseIn:Rr,cubicBezierEaseOut:Ar}=qe;function Ir({duration:r="0.3s",leaveDuration:e="0.2s",name:t="slide-in-from-top"}={}){return[b(`&.${t}-transition-leave-active`,{transition:`transform ${e} ${Rr}`}),b(`&.${t}-transition-enter-active`,{transition:`transform ${r} ${Ar}`}),b(`&.${t}-transition-enter-to`,{transform:"translateY(0)"}),b(`&.${t}-transition-enter-from`,{transform:"translateY(-100%)"}),b(`&.${t}-transition-leave-from`,{transform:"translateY(0)"}),b(`&.${t}-transition-leave-to`,{transform:"translateY(-100%)"})]}const{cubicBezierEaseIn:Br,cubicBezierEaseOut:Er}=qe;function Tr({duration:r="0.3s",leaveDuration:e="0.2s",name:t="slide-in-from-bottom"}={}){return[b(`&.${t}-transition-leave-active`,{transition:`transform ${e} ${Br}`}),b(`&.${t}-transition-enter-active`,{transition:`transform ${r} ${Er}`}),b(`&.${t}-transition-enter-to`,{transform:"translateY(0)"}),b(`&.${t}-transition-enter-from`,{transform:"translateY(100%)"}),b(`&.${t}-transition-leave-from`,{transform:"translateY(0)"}),b(`&.${t}-transition-leave-to`,{transform:"translateY(100%)"})]}var Pr=b([w("drawer",`
 ...
 color: var(--n-text-color);
 box-sizing: border-box;
 `,[Sr(),zr(),Ir(),Tr(),te("native-scrollbar",[w("drawer-content-wrapper",`
 overflow: auto;
 height: 100%;
