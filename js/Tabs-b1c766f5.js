import{K as Me,d as X,P as ie,bO as Ue,h as r,k as D,ab as Xe,F as Ke,X as Ge,as as qe,be as Qe,a4 as Je,_ as l,a9 as g,a0 as R,$ as A,a8 as Ye,O as Ze,a1 as se,v as P,a_ as ee,aj as N,ad as et,w as tt,a2 as at,S as W,cQ as nt,aE as rt,ai as B,Q as ot,V as te,aF as ae,cR as it,cS as st,a7 as O,aW as lt,b1 as dt,cm as ct,cT as bt,b2 as ft}from"./index-e59897ea.js";import{A as ut}from"./Add-22e7fe31.js";import{t as V}from"./throttle-31f60dcd.js";const K=Me("n-tabs"),le={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]};var yt=X({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:le,setup(e){const n=ie(K,null);return n||Ue("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return r("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}});const vt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Je(le,["displayDirective"]));var U=X({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:vt,setup(e){const{mergedClsPrefixRef:n,valueRef:c,typeRef:f,closableRef:y,tabStyleRef:x,tabChangeIdRef:b,onBeforeLeaveRef:p,triggerRef:w,handleAdd:m,activateTab:u,handleClose:v}=ie(K);return{trigger:w,mergedClosable:D(()=>{if(e.internalAddable)return!1;const{closable:d}=e;return d===void 0?y.value:d}),style:x,clsPrefix:n,value:c,type:f,handleClose(d){d.stopPropagation(),!e.disabled&&v(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){m();return}const{name:d}=e,h=++b.id;if(d!==c.value){const{value:C}=p;C?Promise.resolve(C(e.name,c.value)).then(S=>{S&&b.id===h&&u(d)}):u(d)}}}},render(){const{internalAddable:e,clsPrefix:n,name:c,disabled:f,label:y,tab:x,value:b,mergedClosable:p,style:w,trigger:m,$slots:{default:u}}=this,v=y??x;return r("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?r("div",{class:`${n}-tabs-tab-pad`}):null,r("div",Object.assign({key:c,"data-name":c,"data-disabled":f?!0:void 0},Xe({class:[`${n}-tabs-tab`,b===c&&`${n}-tabs-tab--active`,f&&`${n}-tabs-tab--disabled`,p&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`],onClick:m==="click"?this.activateTab:void 0,onMouseenter:m==="hover"?this.activateTab:void 0,style:e?void 0:w},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),r("span",{class:`${n}-tabs-tab__label`},e?r(Ke,null,r("div",{class:`${n}-tabs-tab__height-placeholder`},"\xA0"),r(Ge,{clsPrefix:n},{default:()=>r(ut,null)})):u?u():typeof v=="object"?v:qe(v??c)),p&&this.type==="card"?r(Qe,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:f}):null))}}),pt=l("tabs",`
