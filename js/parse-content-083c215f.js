import{P as Be,aP as Kt,k as E,Y as w,_ as b,Z as O,d as U,O as Ne,bk as Gt,h as a,bl as ae,bm as ee,bn as ce,bo as Ye,bp as be,bq as We,br as ne,bs as ke,bt as Ke,bu as $t,bv as xe,bw as se,bx as De,v as P,b6 as ye,by as $e,K as Jt,aE as nt,y as St,bz as _e,bA as Ge,bB as Je,bC as et,ae as en,av as tn,a7 as te,aa as nn,L as rn,$ as Se,a0 as Re,ab as Ae,ac as ut,w as je,ai as dt,Q as rt,a$ as Ct,b0 as tt,ao as on,ap as sn,aq as ln,ar as it,b1 as Ve,b3 as an,bD as cn,a5 as me,N as ue,aW as un,ba as dn,j as zt,bE as ot,bF as hn,bG as pn,bH as fn,b2 as ht,bI as gn,a9 as mn,an as _t,bJ as qe,bK as bn,am as pt,bL as xn,bM as vn,bN as wn,bO as kn,be as yn,o as Rt,b as At,e as st,bP as $n,bQ as Sn,bR as Cn,bS as zn,bT as _n,bU as Rn,n as An,bV as In,I as Bn,a as ft,F as En}from"./index-deb90793.js";import{N as It}from"./Form-3cef986e.js";import{N as le}from"./FormItem-212114e6.js";import{N as Tn}from"./Switch-319d682b.js";import{N as Pn,a as Un}from"./CollapseItem-68624e2e.js";import{N as gt}from"./InputNumber-3b987c65.js";import{H as Dn}from"./rounded-button-11cc7b25.js";import{P as jn}from"./toggle-93a59bf0.js";import{l as Fn}from"./js-yaml-fae8e8ce.js";function Mn(r,e){const t=Be(Kt,null);return E(()=>r.hljs||t?.mergedHljsRef.value)}var Vn=w("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
...
`,[b(">",[w("input",[b("&:not(:last-child)",`
 ...
 filter: blur(2px);
 content: "";
 `)])])])])]);const pr=Object.assign(Object.assign({},Se.props),{value:String,show:{type:Boolean,default:void 0},defaultShow:{type:Boolean,default:!1},defaultValue:String,modes:{type:Array,default:()=>["rgb","hex","hsl"]},placement:{type:String,default:"bottom-start"},to:tt.propTo,showAlpha:{type:Boolean,default:!0},showPreview:Boolean,swatches:Array,disabled:{type:Boolean,default:void 0},actions:{type:Array,default:null},internalActions:Array,size:String,renderLabel:Function,onComplete:Function,"onUpdate:show":[Function,Array],onUpdateShow:[Function,Array],"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]});var fr=U({name:"ColorPicker",props:pr,setup(r,{slots:e}){const t=P(null);let n=null;const i=nn(r),{mergedSizeRef:o,mergedDisabledRef:s}=i,{localeRef:l}=rn("global"),{mergedClsPrefixRef:c,namespaceRef:f,inlineThemeDisabled:d}=Ne(r),$=Se("ColorPicker","-color-picker",hr,cn,r,c);Re(lt,{themeRef:$,renderLabelRef:Ae(r,"renderLabel"),colorPickerSlots:e});const m=P(r.defaultShow),h=ut(Ae(r,"show"),m);function k(u){const{onUpdateShow:C,"onUpdate:show":I}=r;C&&me(C,u),I&&me(I,u),m.value=u}const{defaultValue:y}=r,z=P(y===void 0?qn(r.modes,r.showAlpha):y),x=ut(Ae(r,"value"),z),S=P([x.value]),D=P(0),N=E(()=>Ie(x.value)),{modes:L}=r,R=P(Ie(x.value)||L[0]||"rgb");function Y(){const{modes:u}=r,{value:C}=R,I=u.findIndex(T=>T===C);~I?R.value=u[(I+1)%u.length]:R.value="rgb"}let A,F,Z,oe,W,K,G,H;const de=E(()=>{const{value:u}=x;if(!u)return null;switch(N.value){case"hsv":return xe(u);case"hsl":return[A,F,Z,H]=ke(u),[...$t(A,F,Z),H];case"rgb":case"hex":return[W,K,G,H]=ee(u),[...We(W,K,G),H]}}),he=E(()=>{const{value:u}=x;if(!u)return null;switch(N.value){case"rgb":case"hex":return ee(u);case"hsv":return[A,F,oe,H]=xe(u),[...se(A,F,oe),H];case"hsl":return[A,F,Z,H]=ke(u),[...Ke(A,F,Z),H]}}),He=E(()=>{const{value:u}=x;if(!u)return null;switch(N.value){case"hsl":return ke(u);case"hsv":return[A,F,oe,H]=xe(u),[...De(A,F,oe),H];case"rgb":case"hex":return[W,K,G,H]=ee(u),[...Ye(W,K,G),H]}}),Ft=E(()=>{switch(R.value){case"rgb":case"hex":return he.value;case"hsv":return de.value;case"hsl":return He.value}}),Ee=P(0),Le=P(1),Ze=P([0,0]);function Mt(u,C){const{value:I}=de,T=Ee.value,j=I?I[3]:1;Ze.value=[u,C];const{showAlpha:B}=r;switch(R.value){case"hsv":V((B?be:et)([T,u,C,j]),"cursor");break;case"hsl":V((B?ce:Ge)([...De(T,u,C),j]),"cursor");break;case"rgb":V((B?ne:Je)([...se(T,u,C),j]),"cursor");break;case"hex":V((B?ae:_e)([...se(T,u,C),j]),"cursor");break}}function Vt(u){Ee.value=u;const{value:C}=de;if(!C)return;const[,I,T,j]=C,{showAlpha:B}=r;switch(R.value){case"hsv":V((B?be:et)([u,I,T,j]),"cursor");break;case"rgb":V((B?ne:Je)([...se(u,I,T),j]),"cursor");break;case"hex":V((B?ae:_e)([...se(u,I,T),j]),"cursor");break;case"hsl":V((B?ce:Ge)([...De(u,I,T),j]),"cursor");break}}function Ot(u){switch(R.value){case"hsv":[A,F,oe]=de.value,V(be([A,F,oe,u]),"cursor");break;case"rgb":[W,K,G]=he.value,V(ne([W,K,G,u]),"cursor");break;case"hex":[W,K,G]=he.value,V(ae([W,K,G,u]),"cursor");break;case"hsl":[A,F,Z]=He.value,V(ce([A,F,Z,u]),"cursor");break}Le.value=u}function V(u,C){C==="cursor"?n=u:n=null;const{nTriggerFormChange:I,nTriggerFormInput:T}=i,{onUpdateValue:j,"onUpdate:value":B}=r;j&&me(j,u),B&&me(B,u),I(),T(),z.value=u}function Nt(u){V(u,"input"),un(ve)}function ve(u=!0){const{value:C}=x;if(C){const{nTriggerFormChange:I,nTriggerFormInput:T}=i,{onComplete:j}=r;j&&j(C);const{value:B}=S,{value:Q}=D;u&&(B.splice(Q+1,B.length,C),D.value=Q+1),I(),T()}}function qt(){const{value:u}=D;u-1<0||(V(S.value[u-1],"input"),ve(!1),D.value=u-1)}function Ht(){const{value:u}=D;u<0||u+1>=S.value.length||(V(S.value[u+1],"input"),ve(!1),D.value=u+1)}function Lt(){k(!1)}const Zt=E(()=>D.value>=1),Qt=E(()=>{const{value:u}=S;return u.length>1&&D.value<u.length-1});je(h,u=>{u||(S.value=[x.value],D.value=0)}),nt(()=>{if(!(n&&n===x.value)){const{value:u}=de;u&&(Ee.value=u[0],Le.value=u[3],Ze.value=[u[1],u[2]])}n=null});const Qe=E(()=>{const{value:u}=o,{common:{cubicBezierEaseInOut:C},self:{textColor:I,color:T,panelFontSize:j,boxShadow:B,border:Q,borderRadius:q,dividerColor:pe,[dt("height",u)]:Yt,[dt("fontSize",u)]:Wt}}=$.value;return{"--n-bezier":C,"--n-text-color":I,"--n-color":T,"--n-panel-font-size":j,"--n-font-size":Wt,"--n-box-shadow":B,"--n-border":Q,"--n-border-radius":q,"--n-height":Yt,"--n-divider-color":pe}}),J=d?rt("color-picker",E(()=>o.value[0]),Qe,r):void 0;function Xt(){var u;const{value:C}=he,{value:I}=Ee,{internalActions:T,modes:j,actions:B}=r,{value:Q}=$,{value:q}=c;return a("div",{class:[`${q}-color-picker-panel`,J?.themeClass.value],onDragstart:pe=>{pe.preventDefault()},style:d?void 0:Qe.value},a("div",{class:`${q}-color-picker-control`},a(Jn,{clsPrefix:q,rgba:C,displayedHue:I,displayedSv:Ze.value,onUpdateSV:Mt,onComplete:ve}),a("div",{class:`${q}-color-picker-preview`},a("div",{class:`${q}-color-picker-preview__sliders`},a(Wn,{clsPrefix:q,hue:I,onUpdateHue:Vt,onComplete:ve}),r.showAlpha?a(Gn,{clsPrefix:q,rgba:C,alpha:Le.value,onUpdateAlpha:Ot,onComplete:ve}):null),r.showPreview?a(dr,{clsPrefix:q,mode:R.value,color:he.value&&_e(he.value),onUpdateColor:pe=>V(pe,"input")}):null),a(sr,{clsPrefix:q,showAlpha:r.showAlpha,mode:R.value,modes:j,onUpdateMode:Y,value:x.value,valueArr:Ft.value,onUpdateValue:Nt}),((u=r.swatches)===null||u===void 0?void 0:u.length)&&a(ur,{clsPrefix:q,mode:R.value,swatches:r.swatches,onUpdateColor:pe=>V(pe,"input")})),B?.length?a("div",{class:`${q}-color-picker-action`},B.includes("confirm")&&a(ue,{size:"small",onClick:Lt,theme:Q.peers.Button,themeOverrides:Q.peerOverrides.Button},{default:()=>l.value.confirm})):null,e.action?a("div",{class:`${q}-color-picker-action`},{default:e.action}):T?a("div",{class:`${q}-color-picker-action`},T.includes("undo")&&a(ue,{size:"small",onClick:qt,disabled:!Zt.value,theme:Q.peers.Button,themeOverrides:Q.peerOverrides.Button},{default:()=>l.value.undo}),T.includes("redo")&&a(ue,{size:"small",onClick:Ht,disabled:!Qt.value,theme:Q.peers.Button,themeOverrides:Q.peerOverrides.Button},{default:()=>l.value.redo})):null)}return{mergedClsPrefix:c,namespace:f,selfRef:t,hsla:He,rgba:he,mergedShow:h,mergedDisabled:s,isMounted:Ct(),adjustedTo:tt(r),mergedValue:x,handleTriggerClick(){k(!0)},handleClickOutside(u){var C;!((C=t.value)===null||C===void 0)&&C.contains(u.target)||k(!1)},renderPanel:Xt,cssVars:d?void 0:Qe,themeClass:J?.themeClass,onRender:J?.onRender}},render(){const{$slots:r,mergedClsPrefix:e,onRender:t}=this;return t?.(),a("div",{class:[this.themeClass,`${e}-color-picker`],ref:"selfRef",style:this.cssVars},a(on,null,{default:()=>[a(sn,null,{default:()=>a(lr,{clsPrefix:e,value:this.mergedValue,hsla:this.hsla,disabled:this.mergedDisabled,onClick:this.handleTriggerClick},{label:r.label})}),a(ln,{placement:this.placement,show:this.mergedShow,containerClass:this.namespace,teleportDisabled:this.adjustedTo===tt.tdkey,to:this.adjustedTo},{default:()=>a(it,{name:"fade-in-scale-up-transition",appear:this.isMounted},{default:()=>this.mergedShow?Ve(this.renderPanel(),[[an,this.handleClickOutside]]):null})})]}))}});const gr=r=>{const{textColor2:e,fontSize:t,fontWeightStrong:n}=r;return{textColor:e,fontSize:t,fontWeightStrong:n,"mono-3":"#a0a1a7","hue-1":"#0184bb","hue-2":"#4078f2","hue-3":"#a626a4","hue-4":"#50a14f","hue-5":"#e45649","hue-5-2":"#c91243","hue-6":"#986801","hue-6-2":"#c18401"}},mr={name:"Code",common:dn,self:gr};var br=mr,xr=b([w("code",`
 font-size: var(--n-font-size);
...
`&&(A+=1),A>1)return!0;return!1});!x.loose&&N.length&&L&&(x.loose=!0,x.items[l].loose=!0)}return x}}html(e){const t=this.rules.block.html.exec(e);if(t){const n={type:"html",raw:t[0],pre:!this.options.sanitizer&&(t[1]==="pre"||t[1]==="script"||t[1]==="style"),text:t[0]};return this.options.sanitize&&(n.type="paragraph",n.text=this.options.sanitizer?this.options.sanitizer(t[0]):M(t[0]),n.tokens=[],this.lexer.inline(n.text,n.tokens)),n}}def(e){const t=this.rules.block.def.exec(e);if(t){t[3]&&(t[3]=t[3].substring(1,t[3].length-1));const n=t[1].toLowerCase().replace(/\s+/g," ");return{type:"def",tag:n,raw:t[0],href:t[2],title:t[3]}}}table(e){const t=this.rules.block.table.exec(e);if(t){const n={type:"table",header:vt(t[1]).map(i=>({text:i})),align:t[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split(`
...
`).replace(/\t/g,"    "),this.blockTokens(e,this.tokens);let t;for(;t=this.inlineQueue.shift();)this.inlineTokens(t.src,t.tokens);return this.tokens}blockTokens(e,t=[]){this.options.pedantic&&(e=e.replace(/^ +$/gm,""));let n,i,o,s;for(;e;)if(!(this.options.extensions&&this.options.extensions.block&&this.options.extensions.block.some(l=>(n=l.call({lexer:this},e,t))?(e=e.substring(n.raw.length),t.push(n),!0):!1))){if(n=this.tokenizer.space(e)){e=e.substring(n.raw.length),n.raw.length===1&&t.length>0?t[t.length-1].raw+=`
